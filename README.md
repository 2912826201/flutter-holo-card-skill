...
让一张普通卡图在 Flutter 里“活”起来：轻轻拖动，前景浮起、背景退后，彩虹镭射沿着卡面流动，整张前景的素描线条也会跟着亮起来。小时候舍不得买的闪卡，现在可以自己搓啦。
...
- 人物、能量特效、文字、面板和边框会变成流畅的白色素描高光，整张卡一起闪得更完整。
- 线稿由生图模型做整张前景风格转换；如果服务拒绝或结果不可用，就安静关闭线条效果，其他景深和镭射照常工作。
