...
void main() {
  for (final mode in ['height', 'medium']) {
    testWidgets('$mode contour visible with and without foil', (tester) async {
      final output = Directory('qa/contour-fix')..createSync(recursive: true);
      Future<List<int>> render(
        ...
        return (await tester.runAsync(() async {
          ...
          File(
            '${output.path}/$mode-x${pose.dx}-y${pose.dy}-foil$foil-glow$glow-active$activation-power$power.png',
